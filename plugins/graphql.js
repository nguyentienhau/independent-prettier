(function (f) {
	...
	function O(e, t = "", n = {}) {
		return b(e), t !== "" && b(t), { type: ae, breakContents: e, flatContents: t, groupId: n.groupId };
	}
	var xt = { type: ce };
		...
		switch (r.kind) {
			...
			case "OperationDefinition": {
				let i = t.originalText[q(r)] !== "{",
					s = !!r.name;
				return [i ? r.operation : "", i && s ? [" ", n("name")] : "", i && !s && le(r.variableDefinitions) ? " " : "", be(e, n), _(e, n, r), !i && !s ? "" : " ", n("selectionSet")];
			}
...
`,
	...
	function be(e, t) {
		let { node: n } = e;
		return le(n.variableDefinitions) ? y(["(", x([p, E([O("", ", "), p], e.map(t, "variableDefinitions"))]), p, ")"]) : "";
	}
	function Le(e, t) {
		e.kind === "StringValue" &&
			e.block &&
...
`);
	...
	var W = class e extends Error {
		constructor(t, ...n) {
			var r, i, s;
			let { nodes: a, source: u, positions: l, path: T, originalError: h, extensions: D } = Ut(n);
...
` + he(this.source, n);
	...
	function Yt(e, t) {
		...
		for (; i < r; ) {
			...
			switch (s) {
				...
				case 34:
					return n.charCodeAt(i + 1) === 34 && n.charCodeAt(i + 2) === 34 ? Qt(e, i) : $t(e, i);
			}
	...
	function Gt(e, t, n) {
		...
		if ((s === 46 && ((a = !0), (s = r.charCodeAt(++i)), (i = me(e, i, s)), (s = r.charCodeAt(i))), (s === 69 || s === 101) && ((a = !0), (s = r.charCodeAt(++i)), (s === 43 || s === 45) && (s = r.charCodeAt(++i)), (i = me(e, i, s)), (s = r.charCodeAt(i))), s === 46 || de(s))) throw d(e.source, i, `Invalid number, expected digit but got: ${C(e, i)}.`);
	...
	function $t(e, t) {
		...
		for (; i < r; ) {
			...
			if (u === 92) {
				a += n.slice(s, i);
				let l = n.charCodeAt(i + 1) === 117 ? (n.charCodeAt(i + 2) === 123 ? Jt(e, i) : Xt(e, i)) : qt(e, i);
...
`),
	...
	function Kt(e, t) {
		...
		return n.length === 0 ? "{}" : t.length > 2 ? "[" + en(e) + "]" : "{ " + n.map(([i, s]) => i + ": " + te(s, t)).join(", ") + " }";
	}
	function Zt(e, t) {
