(function (n) {
	...
	var O = (r, t, e) => (Ft(r, t, "read from private field"), e ? e.call(r) : t.get(r)),
		P = (r, t, e) => (t.has(r) ? ae("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(r) : t.set(r, e)),
		Y = (r, t, e, s) => (Ft(r, t, "write to private field"), s ? s.call(r, e) : t.set(r, e), e),
	...
	var Ps = ["var", "let", "as", "null", "undefined", "true", "false", "if", "else", "this"],
		yt = class {
			tokenize(t) {
				let e = new Vt(t),
					s = [],
	...
	var Bt = new I(-1, -1, l.Character, 0, ""),
		Vt = class {
			...
			scanComplexOperator(t, e, s, i, n, a) {
				this.advance();
				let o = e;
				return this.peek == s && (this.advance(), (o += i)), n != null && this.peek == n && (this.advance(), (o += a)), Gt(t, this.index, o);
			}
			scanIdentifier() {
				let t = this.index;
				...
				for (this.advance(); ; ) {
					if (!B(this.peek))
						if (this.peek === 95) {
							...
							if ((this.advance(), Fs(this.peek) && this.advance(), !B(this.peek))) return this.error("Invalid exponent", -1);
							e = !1;
						} else break;
					this.advance();
				}
			...
			scanQuestion(t) {
				this.advance();
				let e = "?";
				return (this.peek === 63 || this.peek === 46) && ((e += this.peek === 46 ? "." : "?"), this.advance()), Gt(t, this.index, e);
			}
			error(t, e) {
				let s = this.index + e;
				return _s(s, this.index, `Lexer Error: ${t} at column ${s} in expression [${this.input}]`);
			}
		};
	function me(r) {
		...
		mt = class {
			...
			*_forEachUnquotedChar(t, e) {
				...
				for (let n = e; n < t.length; n++) {
					let a = t[n];
					Dt(t.charCodeAt(n)) && (s === null || s === a) && i % 2 === 0 ? (s = s === null ? a : null) : s === null && (yield n), (i = a === "\\" ? i + 1 : 0);
				}
			}
		},
		gt;
	...
	function Be(r) {
		return (r.type === "OptionalCallExpression" || r.type === "OptionalMemberExpression") && !Jt(r);
	}
	function Te(r, t) {
	...
	(wt = new WeakMap()),
		...
		(De = function (e) {
			c(this, x, se).call(this, e.key.span), Ue(e) && e.value && c(this, x, se).call(this, e.value.span);
		}),
		(We = function (e) {
