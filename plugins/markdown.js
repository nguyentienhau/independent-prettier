(function (n) {
	...
	var Ue = (e, r, t) => ((t = e != null ? el(nl(e)) : {}), Ln(r || !e || !e.__esModule ? xr(t, "default", { value: e, enumerable: !0 }) : t, e)),
						...
						for (R = g.slice(O, S), P = b.now(), Z = 0, Q = 0, me = q, Fe = []; q < k; ) {
							if (((_ = g.charCodeAt(q)), _ !== _ || _ === Ur))
								(z = {
									...
									Fe.push(z),
									_ === Ur && ((Z = q + 1), (Q = 0), (me = void 0), (z.end = Z));
							else if (Q !== void 0)
								if (_ === Ye || _ === lr) (Q += _ === Ye ? 1 : Mr - (Q % Mr)), Q > Mr && ((Q = void 0), (me = q));
								else {
									if (Q < Mr && z && (z.contentStart === z.contentEnd || Cf(v, a, x, [b, g.slice(q, hf), !0]))) break;
									(Q = void 0), (me = q);
								}
							q++;
						}
		...
		function Bf(e, r) {
			...
			function u(i, o, s) {
				let l = o.length,
					...
					y,
					E;
				if ((o.charCodeAt(D) === Ri && ((f = !0), D++), o.charCodeAt(D) === Yr)) {
					if ((D++, f)) return s ? !0 : i(o.slice(0, D))({ type: "text", value: "$" });
					if ((o.charCodeAt(D) === Yr && ((c = !0), D++), (d = o.charCodeAt(D)), !(d === Ni || d === Ii))) {
						for (m = D; D < l; ) {
				...
				if (((F = f - m), !(F < _f))) {
					...
					if (s.charCodeAt(f) === Gi) {
						...
						for (h = [], y !== f && h.push(s.slice(y, f)), f++, p = s.indexOf(Vi, f + 1), p = p === -1 ? c : p; f < c; ) {
							for (E = !1, b = f, g = p, d = p, B = 0; d > b && s.charCodeAt(d - 1) === Dr; ) d--;
							for (; d > b && s.charCodeAt(d - 1) === qt; ) B++, d--;
							for (F <= B && s.indexOf(Tf, b) === d && ((E = !0), (g = d)); b <= g && b - f < m && s.charCodeAt(b) === Dr; ) b++;
	...
	var pr = C((wv, Tu) => {
		...
		function vD(e, r) {
			var t = r.additional,
				...
				j,
				I;
			for (typeof t == "string" && (t = t.charCodeAt(0)), P = Z(), w = i ? Q : oD, h--, D++; ++h < D; )
...
`,
		...
		function ip(e, r, t) {
			for (var n = -1, a = r.length, u = "", i = "", o = "", s = "", l, c, f; ++n < a; )
				if (((l = r.charAt(n)), f))
					if (((f = !1), (u += o), (i += s), (o = ""), (s = ""), l === Yt)) (o = l), (s = l);
					else
						for (u += l, i += l; ++n < a; ) {
				...
				else if (l === Gt && r.charAt(n + 1) === l && r.charAt(n + 2) === l && r.charAt(n + 3) === l) (o += np), (n += 3), (f = !0);
					...
					if (!(s < ap)) {
						...
						if (((c = r.charAt(i)), !(c && c !== Kr))) {
							...
							for (var b = !0; i < u; ) {
								...
								for (b ? ((o += c), (b = !1)) : ((F += c), (y += c)), p = "", i++; i < u && ((c = r.charAt(i)), c === He); ) (p += c), i++;
							...
							for (o += d + F, i = -1, u = f.length; ++i < u; )
								if (((c = f.charAt(i)), c === He || c === dr)) D || (D = f.slice(0, i));
								else if (D) {
									h = f.slice(i);
									break;
								}
...
`,
		...
		function pp(e, r, t) {
			...
			if (r.charAt(p) === Ea) {
				if (t) return !0;
				for (p = 0; p < l; ) {
					for (F = r.indexOf(Vt, p), B = p, b = !1, F === -1 && (F = l); p < l && ((d = r.charAt(p)), !(d !== jt && d !== va)); ) p++;
					if ((r.charAt(p) === Ea ? (p++, (b = !0), r.charAt(p) === jt && p++) : (p = B), (y = r.slice(p, F)), !b && !fp(y))) {
						p = B;
						break;
					}
		...
		function bp(e, r, t) {
			...
			if (!(i !== gp && i !== vp && i !== Ep))
				for (o = i, u += i, s = 1, l = ""; ++n < a; )
					...
					else return s >= Cp && (!i || i === Fp) ? ((u += l), t ? !0 : e(u)({ type: "thematicBreak" })) : void 0;
		}
	});
	var $t = C((Wv, Ta) => {
		"use strict";
...
`,
			...
			Vp = /^( {1,4}|\t)?/gm;
		function jp(e, r, t) {
			for (var n = this, a = n.options.commonmark, u = n.options.pedantic, i = n.blockTokenizers, o = n.interruptList, s = 0, l = r.length, c = null, f, D, h, p, d, m, F, y, E, B, b, g, A, x, v, w, k, q, T, R = !1, O, S, _, P; s < l && ((p = r.charAt(s)), !(p !== Xr && p !== de)); ) s++;
			if (((p = r.charAt(s)), p === Ht || p === La || p === Wt)) (d = p), (h = !1);
			else {
				for (h = !0, D = ""; s < l && ((p = r.charAt(s)), !!Pa(p)); ) (D += p), s++;
			...
			if (((p = r.charAt(++s)), !(p !== de && p !== Xr && (u || (p !== ie && p !== ""))))) {
				if (t) return !0;
				for (s = 0, x = [], v = [], w = []; s < l; ) {
					for (m = r.indexOf(ie, s), F = s, y = !1, P = !1, m === -1 && (m = l), f = 0; s < l; ) {
						if (((p = r.charAt(s)), p === Xr)) f += xe - (f % xe);
						else if (p === de) f++;
						else break;
						s++;
					}
					if ((k && f >= k.indent && (P = !0), (p = r.charAt(s)), (E = null), !P)) {
					...
					if (E) {
						if (!u && d !== E) break;
						y = !0;
					} else !a && !P && r.charAt(F) === de ? (P = !0) : a && k && (P = f >= k.indent || f > xe), (y = !1), (s = F);
					if (((b = r.slice(F, m)), (B = F === s ? b : r.slice(s, m)), (E === Ht || E === Rp || E === Wt) && i.thematicBreak.call(n, e, b, !0))) break;
				...
				for (
					...
					(k = x[s].value.join(ie)), (S = e.now()), e(k)($p(n, k, S), O), (k = x[s].trail.join(ie)), s !== l - 1 && (k += ie), e(k);
				return q(), T(), O;
			}
		}
		function $p(e, r, t) {
			...
			return (
				...
				e.options.gfm && ((i = r.match(Mp)), i && ((o = i[0].length), (u = i[1].toLowerCase() === Up), (n[t.line] += o), (r = r.slice(o)))),
				{
					type: "listItem",
					spread: zp.test(r),
					checked: u,
...
`,
		...
		function wd(e, r, t) {
			for (
				...
				o++;
			if (r.charAt(o) === dd) {
				for (s = r.indexOf($a, o + 1), s = s === -1 ? i : s, l = r.slice(o, s), c = -1, D = d.length; ++c < D; )
					if (d[c][0].test(l)) {
						h = d[c];
						break;
					}
						...
						if (((f = r.charAt(u)), !f || f === Ke))
							return t
								...
								: ((s = e(s).test().end),
									...
									d && ((l = e(l).test().end), (d = n.decode.raw(n.unescape(d), l))),
									e(o)({
										type: "definition",
										identifier: Od(h),
										label: h,
...
`,
		...
		function Kd(e, r, t) {
			...
			if (n.options.gfm) {
				...
				for (o = c.join(et), u = c.splice(1, 1)[0] || [], a = 0, l = u.length, E--, i = !1, p = []; a < l; ) {
				...
				if ((i !== !1 && p.push(i), !(p.length < jd))) {
					...
					for (
						...
						for (B = c[y], s = { type: "tableRow", children: [] }, y && e(et), e(B).reset(s, g), l = B.length + 1, a = 0, f = "", d = "", m = !0; a < l; ) {
							...
							D === "" || D === rn
								? m
									...
									: ((d || D) &&
											!m &&
											((o = d),
											f.length > 1 && (D ? ((o += f.slice(0, -1)), (f = f.charAt(f.length - 1))) : ((o += f), (f = ""))),
											(F = e.now()),
											e(o)(
												{
													type: "tableCell",
										...
										(f = ""),
										(d = ""))
								: (f && ((d += f), (f = "")), (d += D), D === Vd && a !== l - 2 && ((d += B.charAt(a + 1)), a++)),
								(m = !1),
								a++;
						}
						y || e(et + u);
...
`,
		...
		function ho(e, r, t) {
			var n = this,
				a,
				u;
			if (r.charAt(0) === po && ((a = r.charAt(1)), n.escape.indexOf(a) !== -1)) return t ? !0 : (a === ih ? (u = { type: "break" }) : (u = { type: "text", value: a }), e(po + a)(u));
		}
	});
	var tn = C((oE, go) => {
		"use strict";
	...
	var yo = C((sE, bo) => {
		...
		function on(e, r, t) {
			...
			if (r.charAt(0) === Eo) {
				...
				if (o) {
					if (((l += o), (o = ""), (c = r.charAt(i)), (l += c), i++, c === Co)) s = !0;
					else {
					...
					if (((c = r.charAt(i)), !(!o || c !== nn)))
						return t
							...
							: ((l += o),
								...
								f.column++,
								f.offset++,
								s && (l.slice(0, rt).toLowerCase() === an ? ((D = D.slice(rt)), (f.column += rt), (f.offset += rt)) : (l = an + l)),
		...
		function ln(e, r, t) {
			...
			if (a) {
				...
				if ((d === cn && (l.pop(), D--), l[0] !== void 0 && ((c = l.length < 2 ? f : l[l.length - 2] + 1), r.slice(c, D).indexOf("_") === -1))) {
					...
					return (E = r.slice(0, D)), (b = lh(E, { nonTerminated: !1 })), s && (b = "http://" + b), (g = n.enterLink()), (n.inlineTokenizers = { text: u.text }), (B = n.tokenizeInline(E, e.now())), (n.inlineTokenizers = u), g(), e(E)({ type: "link", title: null, url: b, children: B });
				}
			}
		}
	});
	...
	var Vo = C((dE, Go) => {
		...
		function Yo(e, r, t) {
			var n = this,
				...
				u,
				i;
			if (!(r.charAt(0) !== Uh || a < 3) && ((u = r.charAt(1)), !(!Ih(u) && u !== zh && u !== Mh && u !== Yh) && ((i = r.match(Rh)), !!i))) return t ? !0 : ((i = i[0]), !n.inLink && Gh.test(i) ? (n.inLink = !0) : n.inLink && Vh.test(i) && (n.inLink = !1), e(i)({ type: "html", value: i }));
		}
	});
	var dn = C((hE, jo) => {
		"use strict";
...
`,
		...
		function Jo(e, r, t) {
			var n = this,
				...
				w,
				k;
			if ((i === Wh && ((F = !0), (a = i), (i = r.charAt(++u))), i === Wo && !(!F && n.inLink))) {
				...
				if (c) {
					...
					if (((i = r.charAt(u)), (a += A), A && (i === $o || i === Ho || (s && i === Je))))
						if ((u++, (a += i), (A = ""), (E = i === Je ? Cr : i), (p = a), s)) {
							...
							for (d = ""; u < B; ) {
								if (((i = r.charAt(u)), i === E)) m && ((A += E + d), (d = "")), (m = !0);
								else if (!m) A += i;
								else if (i === Cr) {
									(a += A + E + d), (b = A);
									break;
					...
					if (r.charAt(u) === Cr)
						return t
							? !0
							: ((a += Cr),
								(x = n.decode.raw(n.unescape(x), e(h).test().end, { nonTerminated: !1 })),
								...
								F ? (k.alt = n.decode.raw(n.unescape(y), v) || null) : ((w = n.enterLink()), (k.children = n.tokenizeInline(y, v)), w()),
								e(a)(k));
				}
			}
		}
							...
							c === Fn && n.inLink
								...
								: t
									...
									: ((p = e.now()),
										...
										c === Fn ? ((m = n.enterLink()), (d.children = n.tokenizeInline(D, p)), m()) : (d.alt = n.decode.raw(n.unescape(D), p) || null),
										e(s)(d))
						);
				}
			}
	...
	var os = C((vE, as) => {
		...
		function us(e, r, t) {
			var n = this,
				...
				f,
				D;
			if (!((u !== o0 && u !== s0) || r.charAt(++a) !== u) && ((o = n.options.pedantic), (s = u), (c = s + s), (f = r.length), a++, (l = ""), (u = ""), !(o && is(r.charAt(a)))))
				for (; a < f; ) {
	...
	var ms = C((bE, hs) => {
		...
		function ds(e, r, t) {
			var n = this,
				...
				f,
				D;
			if (!(u !== m0 && u !== ps) && ((o = n.options.pedantic), (c = u), (s = u), (f = r.length), a++, (l = ""), (u = ""), !(o && Ds(r.charAt(a)))))
				for (; a < f; ) {
	...
	var Bs = C((wE, ks) => {
		...
		function ws(e, r, t) {
			...
			if (!(a === 0 || a === n)) {
				...
				if (c) {
					if (t) return !0;
					if (((a = u), (n = i), (s = r.charCodeAt(a)), (l = r.charCodeAt(n - 1)), (c = !1), n - a > 2 && (s === En || s === vn) && (l === En || l === vn))) {
						for (a++, n--; a < n; ) {
...
`,
		...
		function _s(e, r, t) {
			for (var n = r.length, a = -1, u = "", i; ++a < n; ) {
				if (((i = r.charAt(a)), i === x0)) return a < w0 ? void 0 : t ? !0 : ((u += i), e(u)({ type: "break" }));
				if (i !== A0) return;
				u += i;
			}
		}
	...
	var Us = C((TE, Rs) => {
		...
		Rs.exports = Is;
		function Is(e, r) {
			(this.file = r), (this.offset = {}), (this.options = B0(this.options)), this.setOptions({}), (this.inList = !1), (this.inBlock = !1), (this.inLink = !1), (this.atStart = !0), (this.toOffset = q0(r).toOffset), (this.unescape = T0(this, "escape")), (this.decode = _0(this));
		}
		var U = Is.prototype;
		U.setOptions = Vu();
		U.parse = aa();
		...
		U.interruptParagraph = [["thematicBreak"], ["list"], ["atxHeading"], ["fencedCode"], ["blockquote"], ["html"], ["setextHeading", { commonmark: !1 }], ["definition", { commonmark: !1 }]];
		U.interruptList = [
	...
	var Ic = C((jE, Lc) => {
		...
		function Pc() {
			...
			function s(m) {
				...
				function b(g, A) {
					var x = l(g);
					x ? (qc(x[1]) && qc(A) && (A = lt(!0, x[1], A)), (x[1] = A)) : e.push(Dm.call(arguments));
				}
			}
			function l(m) {
...
`,
			...
			(e.type === "definition" || e.type === "linkReference" || e.type === "imageReference") && (r.label = (0, Xn.default)(e.label)),
			(e.type === "link" || e.type === "image") && e.url && e.url.includes("("))
		)
			for (let n of "<>") r.url = N(!1, e.url, n, encodeURIComponent(n));
		if (((e.type === "definition" || e.type === "link" || e.type === "image") && e.title && (r.title = N(!1, e.title, /\\(?=["')])/gu, "")), (t == null ? void 0 : t.type) === "root" && t.children.length > 0 && (t.children[0] === e || (Hn(t.children[0]) && t.children[1] === e)) && e.type === "html" && dt(e.value))) return null;
	}
	...
	function xl(e, r) {
		let t = e.plugins.flatMap((a) => a.languages ?? []),
			n = Al(t, r.language) ?? ti(t, r.physicalFile) ?? ti(t, r.file) ?? (r.physicalFile, void 0);
...
`,
				...
				case J: {
					...
					let x = { ind: D, mode: h, doc: Ee(m) },
						v = m[0];
					Nr({ ind: D, mode: ne, doc: [F, y, v] }, [], d, l.length > 0, t, !0) ? i.push(x, g, E) : b ? i.push(x, A, E) : i.push(x, A, B);
					break;
				}
				case X:
				case se: {
	...
	function zl(e, r) {
		return ye(e, (t) =>
			t.type !== "text" || t.value === "*" || t.value === "_" || !Rl.test(t.value) || t.position.end.offset - t.position.start.offset === t.value.length
				? t
				: {
						...t,
	...
	function Zl(e, r, t) {
		...
		switch (n.type) {
			...
			case "word": {
				...
				return i !== n.value && (e.match(void 0, o, s) || e.match(void 0, o, (l, c, f) => l.type === "emphasis" && f === 0, s)) && (i = i.replace(/^(\\?[*_])+/u, (l) => N(!1, l, "\\", ""))), i;
			}
			case "whitespace": {
				let { next: i } = e,
...
`,
	...
	function V(e, r, t, n = {}) {
		...
		return (
			e.each(() => {
				let i = a(e);
				i !== !1 && (u.length > 0 && nf(e) && (u.push(L), (uf(e, r) || ki(e)) && u.push(L), ki(e) && u.push(L)), u.push(i));
			}, "children"),
			u
		);
	}
...
`)
	...
	function Rr(e, r, t = !0) {
		...
		if (((e = N(!1, e, /\\(?=["')])/gu, "")), e.includes('"') && e.includes("'") && !e.includes(")"))) return `(${e})`;
