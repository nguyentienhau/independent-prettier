...
` ||
	...
	var yo = v(["Block", "CommentBlock", "MultiLine"]),
		re = yo;
	var Do = v(["AnyTypeAnnotation", "ThisTypeAnnotation", "NumberTypeAnnotation", "VoidTypeAnnotation", "BooleanTypeAnnotation", "BigIntTypeAnnotation", "SymbolTypeAnnotation", "StringTypeAnnotation", "NeverTypeAnnotation", "UndefinedTypeAnnotation", "UnknownTypeAnnotation", "EmptyTypeAnnotation", "MixedTypeAnnotation"]),
		Sr = Do;
	function fo(e, t) {
		let r = t.split(".");
	...
	var kr = v(["Literal", "BooleanLiteral", "BigIntLiteral", "DecimalLiteral", "DirectiveLiteral", "NullLiteral", "NumericLiteral", "RegExpLiteral", "StringLiteral"]),
		Co = v(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier", "Import"]),
	...
	var To = v(["TSThisType", "NullLiteralTypeAnnotation", "BooleanLiteralTypeAnnotation", "StringLiteralTypeAnnotation", "BigIntLiteralTypeAnnotation", "NumberLiteralTypeAnnotation", "TSLiteralType", "TSTemplateLiteralType"]);
	function Mt(e) {
		return Br(e) || Sr(e) || To(e) || ((e.type === "GenericTypeAnnotation" || e.type === "TSTypeReference") && !e.typeParameters && !e.typeArguments);
	}
	function xo(e) {
		return e.type === "Identifier" && (e.name === "beforeEach" || e.name === "beforeAll" || e.name === "afterEach" || e.name === "afterAll");
	}
	var ho = ["it", "it.only", "it.skip", "describe", "describe.only", "describe.skip", "test", "test.only", "test.skip", "test.step", "test.describe", "test.describe.only", "test.describe.parallel", "test.describe.parallel.only", "test.describe.serial", "test.describe.serial.only", "skip", "xit", "xdescribe", "xtest", "fit", "fdescribe", "ftest"];
	function go(e) {
		return ru(e, ho);
	}
	function St(e, t) {
		...
		} else if ((r.length === 2 || r.length === 3) && (r[0].type === "TemplateLiteral" || Q(r[0])) && go(e.callee)) return r[2] && !Ce(r[2]) ? !1 : (r.length === 2 ? _t(r[1]) : Ao(r[1]) && K(r[1]).length <= 1) || wn(r[1]);
		return !1;
	}
	...
	function rr(e, t) {
		...
		if (d(e)) return !1;
		let n = r * So;
		if (e.type === "ThisExpression" || (e.type === "Identifier" && e.name.length <= n) || (vn(e) && !d(e.argument))) return !0;
...
`),
		...
		return q(e) ? be(e.object, t) && be(e.property, t) : (e.type === "UnaryExpression" && Bo.has(e.operator)) || e.type === "UpdateExpression" ? be(e.argument, t) : !1;
	}
	function fe(e) {
		var t;
	...
	var su = { "==": !0, "!=": !0, "===": !0, "!==": !0 },
		...
		jn = { ">>": !0, ">>>": !0, "<<": !0 };
	function nr(e, t) {
		return !(er(t) !== er(e) || e === "**" || (su[e] && su[t]) || (t === "%" && br[e]) || (e === "%" && br[t]) || (t !== e && br[t] && br[e]) || (jn[e] && jn[t]));
	}
	...
	function oe(e) {
		...
		let t = e.arguments;
		return e.type === "ImportExpression" && ((t = [e.source]), e.attributes && t.push(e.attributes), e.options && t.push(e.options)), _n.set(e, t), t;
	}
	function Rt(e, t) {
		let { node: r } = e;
	...
	var Po = new Set(["range", "raw", "comments", "leadingComments", "trailingComments", "innerComments", "extra", "start", "end", "loc", "flags", "errors", "tokens"]),
		Jt = (e) => {
	...
	var ut = ko;
	var Io = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
	function Lo(e) {
...
`);
	...
	function Xn(e, t) {
		(e.comments ?? (e.comments = [])).push(t), (t.printed = !1), (t.nodeDescription = qo(e));
	}
	function ce(e, t) {
...
`
	...
	var ku = No;
	function Xo(e) {
		return [Mu, Lu, _u, sp, $o, Hn, Vn, Iu, wu, op, ip, Kn, vu, pp, Ou, ju, $n, Ko, Fp].some((t) => t(e));
	}
	function Yo(e) {
		return [Vo, _u, Lu, vu, Hn, Vn, Iu, wu, ju, up, ap, Kn, mp, $n, fp, Ep].some((t) => t(e));
	}
	function Ho(e) {
	...
	function Hn({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
		...
		return n.type === "BlockStatement" ? (bt(n, e), !0) : n.type === "IfStatement" ? (Yn(n.consequent, e), !0) : r.consequent === n ? (ce(n, e), !0) : !1;
	}
	...
	function Iu({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
		return ((r == null ? void 0 : r.type) !== "TryStatement" && (r == null ? void 0 : r.type) !== "CatchClause") || !n ? !1 : r.type === "CatchClause" && t ? (z(t, e), !0) : n.type === "BlockStatement" ? (bt(n, e), !0) : n.type === "TryStatement" ? (Yn(n.finalizer, e), !0) : n.type === "CatchClause" ? (Yn(n.body, e), !0) : !1;
	}
	...
	var Qo = new Set(["ClassDeclaration", "ClassExpression", "DeclareClass", "DeclareInterface", "InterfaceDeclaration", "TSInterfaceDeclaration"]);
	...
	var Zo = new Set(["ClassMethod", "ClassProperty", "PropertyDefinition", "TSAbstractPropertyDefinition", "TSAbstractMethodDefinition", "TSDeclareMethod", "MethodDefinition", "ClassAccessorProperty", "AccessorProperty", "TSAbstractAccessorProperty"]);
	function Ou({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
		return r && t && ge(n, k(e)) === "(" && (r.type === "Property" || r.type === "TSDeclareMethod" || r.type === "TSAbstractMethodDefinition") && t.type === "Identifier" && r.key === t && ge(n, k(t)) !== ":" ? (z(t, e), !0) : (t == null ? void 0 : t.type) === "Decorator" && Zo.has(r == null ? void 0 : r.type) ? (z(t, e), !0) : !1;
	}
	var ep = new Set(["FunctionDeclaration", "FunctionExpression", "ClassMethod", "MethodDefinition", "ObjectMethod"]);
	function tp({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
		return ge(n, k(e)) !== "(" ? !1 : t && ep.has(r == null ? void 0 : r.type) ? (z(t, e), !0) : !1;
	}
	...
	function sp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	...
	function ip({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
	...
	var cp = new Set(["VariableDeclarator", "AssignmentExpression", "TypeAlias", "TSTypeAliasDeclaration"]),
		lp = new Set(["ObjectExpression", "RecordExpression", "ArrayExpression", "TupleExpression", "TemplateLiteral", "TaggedTemplateExpression", "ObjectTypeAnnotation", "TSTypeLiteral"]);
	function mp({ comment: e, enclosingNode: t, followingNode: r }) {
		return cp.has(t == null ? void 0 : t.type) && r && (lp.has(r.type) || re(e)) ? (ce(r, e), !0) : !1;
	}
	...
	var Cp = new Set(["EmptyStatement", "TemplateElement", "Import", "TSEmptyBodyFunctionExpression", "ChainExpression"]);
	function Ap(e) {
				...
				case me:
					switch (C) {
						...
						case Se:
							...
							p.literal ? (y.root ? (a.push(s, y.root.value), (u = y.root.length)) : (a.push(s), (u = 0))) : ((u -= es(a)), a.push(s + y.value), (u = y.length));
							break;
					}
					break;
				case je:
...
`) && o.push({ hasLineBreak: !1, cells: [] });
	...
	function Wr(e, t) {
		return mt(e, (r) => (typeof r == "string" ? (t ? N(!1, r, /(\\*)`/gu, "$1$1\\`") : rs(r)) : r));
	}
	function rs(e) {
	...
	var ss = [(e, t) => e.type === "ObjectExpression" && t === "properties", (e, t) => e.type === "CallExpression" && e.callee.type === "Identifier" && e.callee.name === "Component" && t === "arguments", (e, t) => e.type === "Decorator" && t === "expression"];
	function Nu(e) {
		let t = (n) => n.type === "TemplateLiteral",
			r = (n, s) => Ae(n) && !n.computed && n.key.type === "Identifier" && n.key.name === "styles" && s === "value";
		return e.match(t, (n, s) => U(n) && s === "elements", r, ...ss) || e.match(t, r, ...ss);
	}
	function Xu(e) {
		return e.match(
	...
	function Gr({ node: e, parent: t }, r) {
		return ns(e, r) || (kp(t) && ns(t, r)) || (t.type === "ExpressionStatement" && ns(t, r));
	}
	function kp(e) {
...
`),
			...
			let B = null;
			S ? (B = Mp(y)) : (B = await e(D, { parser: "graphql" })), B ? ((B = Wr(B, !1)), !c && A && i.push(""), i.push(B), !m && T && i.push("")) : !c && !m && A && i.push(""), p && i.push(p);
		}
		return ["`", f([F, P(F, i)]), F, "`"];
	}
	function Mp(e) {
		...
		let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`,
			...
			C = mt(y, (S) => {
				...
				for (let J = 0; J < _.length; J++) {
					let j = _[J];
					if (J % 2 === 0) {
						j && ((j = rs(j)), s.__embeddedInHtml && (j = N(!1, j, /<\/(?=script\b)/giu, String.raw`<\/`)), B.push(j));
						continue;
					}
					let h = Number(j);
					B.push(c[h]);
...
`) +
	...
	function is(e, t) {
		...
		if (t.__isInHtmlInterpolation && !t.bracketSpacing && ac(r) && or(e)) return !0;
		if (sc(r)) return !1;
		...
		switch (s.type) {
			...
			case "Decorator":
				...
				break;
			case "TypeAnnotation":
				if (e.match(void 0, void 0, (p, A) => A === "returnType" && p.type === "ArrowFunctionExpression") && ic(r)) return !0;
				break;
			case "BinaryExpression":
		...
		switch (r.type) {
			...
			case "BinaryExpression":
				if (s.type === "UpdateExpression" || (r.operator === "in" && uc(e))) return !0;
	...
	function li(e, t) {
		...
		return r.type === "FunctionExpression" || r.type === "ClassExpression" ? n.type === "ExportDefaultDeclaration" || !is(e, t) : !jt(r) || (n.type !== "ExportDefaultDeclaration" && is(e, t)) ? !1 : e.call(() => li(e, t), ...Pr(r));
	}
	function oc(e) {
	...
	function as(e) {
		return e.type === "Identifier" ? !0 : q(e) ? !e.computed && !e.optional && e.property.type === "Identifier" && as(e.object) : !1;
	}
	function pc(e) {
		return e.type === "ChainExpression" && (e = e.expression), as(e) || (L(e) && !e.optional && as(e.callee));
	}
	var Be = is;
	function cc(e, t) {
		let r = t - 1;
	...
	function yc(e, t, r) {
		...
		return !o || (r != null && r.hasLineSuffix) ? { doc: [Gn([" ", s]), Ee], isBlock: o, hasLineSuffix: !0 } : { doc: [" ", s], isBlock: o, hasLineSuffix: !1 };
	}
	function M(e, t, r = {}) {
		let { node: n } = e;
...
\r	`),
	...
	function Dc(e, t, r) {
		...
		n.children = n.children.map((h) => (kc(h) ? { type: "JSXText", value: " ", raw: " " } : h));
		...
		if ((((j = t.cursorNode) == null ? void 0 : j.type) === "JSXText" && n.children.includes(t.cursorNode) && (S = [Nn, S, Nn]), m)) return S;
		let B = l([s, f([F, S]), F, u]);
	...
	var Ec = new Set(["ArrayExpression", "TupleExpression", "JSXAttribute", "JSXElement", "JSXExpressionContainer", "JSXFragment", "ExpressionStatement", "CallExpression", "OptionalCallExpression", "ConditionalExpression", "JsExpressionRoot"]);
	function Fc(e, t, r) {
		let { parent: n } = e;
...
`),
	...
	function Ds(e, t, r, n, s) {
		...
		if (!De(u)) return [l(t())];
		let i = [];
		nr(u.operator, u.left.operator) ? (i = e.call((T) => Ds(T, t, r, !0, s), "left")) : i.push(l(t("left")));
		let a = Ut(u),
			o = (u.operator === "|>" || u.type === "NGPipeExpression" || wc(e, r)) && !Oe(r.originalText, u.right),
		...
		if (a) D = [c, " ", t("right"), m];
			...
			let S = c === "|>" && ((A = e.root.extra) == null ? void 0 : A.__isUsingHackPipeline) ? e.call((B) => Ds(B, t, r, !0, s), "right") : t("right");
			D = [o ? x : "", c, o ? " " : x, S, m];
		}
		let { parent: y } = e,
	...
	function vc(e, t, r) {
		...
		let s = O(!1, e, -2);
		return !d(n, g.Leading) && !d(n, g.Trailing) && cr(n) && (!s || s.type !== n.type) && (e.length !== 2 || s.type !== "ArrowFunctionExpression" || !U(n)) && !(e.length > 1 && Es(n, r));
	}
	function Mc(e) {
		if (e.length !== 2) return !1;
		let [t, r] = e;
		return t.type === "ModuleExpression" && qc(r) ? !0 : !d(t) && (t.type === "FunctionExpression" || (t.type === "ArrowFunctionExpression" && t.body.type === "BlockStatement")) && r.type !== "FunctionExpression" && r.type !== "ArrowFunctionExpression" && r.type !== "ConditionalExpression" && Bi(r) && !cr(r);
	}
	function Bi(e) {
		...
		return lt(e) && oe(e).length > 1 ? !1 : De(e) ? be(e.left, 1) && be(e.right, 1) : Mn(e) || be(e);
	}
	function Rc(e) {
	...
	function bi(e, t, r) {
		...
		let n = r("object"),
			...
			o = (i && (i.type === "NewExpression" || i.type === "BindExpression" || (i.type === "AssignmentExpression" && i.left.type !== "Identifier"))) || u.computed || (u.object.type === "Identifier" && u.property.type === "Identifier" && !q(a)) || ((a.type === "AssignmentExpression" || a.type === "VariableDeclarator") && (Wc(u.object) || ((c = n.label) == null ? void 0 : c.memberChain)));
	...
	function Uc(e, t, r, n, s) {
		...
		let D = zc(u, n, t);
		return e.call(() => Nc(e, t, r, D), s) ? "break-after-operator" : Yc(u) ? "break-lhs" : !m && (D || i.type === "TemplateLiteral" || i.type === "TaggedTemplateExpression" || i.type === "BooleanLiteral" || Ce(i) || i.type === "ClassExpression") ? "never-break-after-operator" : "fluid";
	}
	function Nc(e, t, r, n) {
		let s = e.node;
	...
	function ji(e, t, r, n = !1) {
		...
		if (L(s)) {
			...
			let o = oe(s);
			return !(o.length === 0 || (o.length === 1 && rr(o[0], t))) || Qc(s, r) ? !1 : e.call(u, "callee");
		}
	...
	var nl = v(["VoidTypeAnnotation", "TSVoidKeyword", "NullLiteralTypeAnnotation", "TSNullKeyword"]),
		sl = v(["ObjectTypeAnnotation", "TSTypeLiteral", "GenericTypeAnnotation", "TSTypeReference"]);
	function ul(e) {
		let { types: t } = e;
	...
	function Zr(e, t, r) {
		...
		let u = Je(e, r, t, !1, !0),
			i = [];
		return n.type === "FunctionTypeAnnotation" ? i.push(il(e) ? " => " : ": ", r("returnType")) : i.push(Y(e, r, n.returnType ? "returnType" : "typeAnnotation")), ot(n, i) && (u = l(u)), s.push(u, i), l(s);
	}
	function en(e, t, r) {
	...
	var ol = new Set(["DeclareClass", "DeclareComponent", "DeclareFunction", "DeclareHook", "DeclareVariable", "DeclareExportDeclaration", "DeclareExportAllDeclaration", "DeclareOpaqueType", "DeclareTypeAlias", "DeclareEnum", "DeclareInterface"]);
	function $(e) {
		let { node: t } = e;
		return t.declare || (ol.has(t.type) && e.parent.type !== "DeclareExportDeclaration") ? "declare " : "";
	}
	var pl = new Set(["TSAbstractMethodDefinition", "TSAbstractPropertyDefinition", "TSAbstractAccessorProperty"]);
	function Nt({ node: e }) {
	...
	function Yt(e, t, r) {
		...
		if (o.length === 0) s.push(cl(e, t, u, i));
			...
			s.push(l([u, f([E, p ? ml(e, t, r, A) : [ll(e, t, a, n.inexact, r), A], M(e, t)]), E, i], { shouldBreak: C, id: y }));
		}
		return s.push(V(e), Y(e, r)), s;
	}
	function Es(e, t) {
		return U(e) && e.elements.length > 1 && e.elements.every((r) => r && (Ce(r) || (vn(r) && !d(r.argument))) && !d(r, g.Trailing | g.Line, (n) => !te(t.originalText, R(n), { backwards: !0 })));
	}
	...
	var Fl = ({ node: e, key: t, parent: r }) => t === "value" && e.type === "FunctionExpression" && (r.type === "ObjectMethod" || r.type === "ClassMethod" || r.type === "ClassPrivateMethod" || r.type === "MethodDefinition" || r.type === "TSAbstractMethodDefinition" || r.type === "TSDeclareMethod" || (r.type === "Property" && gt(r)));
	function Dn(e, t, r, n) {
	...
	function Ni(e, t, r) {
		...
		if (n.argument) {
			let o = r("argument");
			Al(t, n.argument) ? (o = ["(", f([F, o]), F, ")"]) : (De(n.argument) || n.argument.type === "SequenceExpression" || (t.experimentalTernaries && n.argument.type === "ConditionalExpression" && (n.argument.consequent.type === "ConditionalExpression" || n.argument.alternate.type === "ConditionalExpression"))) && (o = l([b("("), f([E, o]), E, b(")")])), u.push(" ", o);
		}
	...
	var xs = new WeakMap();
	function Hi(e) {
		return xs.has(e) || xs.set(e, e.type === "ConditionalExpression" && !ie(e, (t) => t.type === "ObjectExpression")), xs.get(e);
	}
	...
	function Qi(e, t, r) {
		...
		return l(["{", f([t.bracketSpacing ? x : E, l([r("typeParameter"), n.optional ? hs(n.optional, "?") : "", n.typeAnnotation ? ": " : "", r("typeAnnotation")]), t.semi ? b(";") : ""]), M(e, t), t.bracketSpacing ? x : E, "}"], { shouldBreak: s });
	}
	...
	function Pt(e, t, r, n) {
		...
		if (s[n].length === 0 || (!i && (u || (s[n].length === 1 && (s[n][0].type === "NullableTypeAnnotation" || Ts(s[n][0])))))) return ["<", P(", ", e.map(r, n)), kl(e, t), ">"];
		let o = s.type === "TSTypeParameterInstantiation" ? "" : Pl(e, t, n) ? "," : ae(t) ? b(",") : "";
	...
	function Tn(e, t, r) {
		...
		if ((n.id && i.push(" ", r("id")), i.push(r("typeParameters")), n.superClass)) {
			let o = [Ll(e, t, r), r(n.superTypeArguments ? "superTypeArguments" : "superTypeParameters")],
	...
	function ta(e) {
		return e.typeParameters && !d(e.typeParameters, g.Trailing | g.Line) && !Il(e);
	}
	function gs(e, t, r, n) {
		let { node: s } = e;
		if (!w(s[n])) return "";
	...
	function dn(e, t, r) {
		let { node: n } = e,
			s = [];
		return w(n.decorators) && s.push(fs(e, t, r)), s.push(Xt(n)), n.static && s.push("static "), s.push(Nt(e)), n.override && s.push("override "), s.push(mr(e, t, r)), s;
	}
	function xn(e, t, r) {
		let { node: n } = e,
			s = [],
			u = t.semi ? ";" : "";
		w(n.decorators) && s.push(fs(e, t, r)), s.push(Xt(n), $(e)), n.static && s.push("static "), s.push(Nt(e)), n.override && s.push("override "), n.readonly && s.push("readonly "), n.variance && s.push(r("variance")), (n.type === "ClassAccessorProperty" || n.type === "AccessorProperty" || n.type === "TSAbstractAccessorProperty") && s.push("accessor "), s.push(Et(e, t, r), V(e), pn(e), Y(e, r));
	...
	function ra(e, t, r) {
		...
		return (
			...
			[w(n.body) ? Ss(e.parent) : "", "{", s.length > 0 ? [f([F, s]), F] : "", "}"]
		);
	}
	function wl(e, t) {
		var s;
	...
	function ua(e, t, r) {
		let n = [r("expression")];
		return Ps(e, t) ? bs(e.node.expression) && n.push(";") : Bs(e, t) || (t.semi && n.push(";")), n;
	}
	function ia(e, t, r) {
	...
	function pa(e, t) {
		...
		switch (r.type) {
			...
			case "Literal": {
				...
				let { value: n } = r;
				return typeof n == "number" ? Ze(r.raw) : typeof n == "string" ? (Ol(e) ? oa(r.raw, t) : Ie(tt(r.raw, t))) : String(n);
			}
		}
	}
	function Ol(e) {
	...
	function ca(e, t, r) {
		let { node: n } = e;
		return ["import", n.module ? " module" : "", n.phase ? ` ${n.phase}` : "", Is(n), ya(e, t, r), ma(e, t, r), fa(e, t, r), t.semi ? ";" : ""];
	}
	...
	function gn(e, t, r) {
		...
		return d(n, g.Dangling) && (s.push(" ", M(e, t)), wr(n) && s.push(F)), u ? s.push(" ", r("declaration")) : (s.push(Ml(n)), n.type === "ExportAllDeclaration" || n.type === "DeclareExportAllDeclaration" ? (s.push(" *"), i && s.push(" as ", r("exported"))) : s.push(ya(e, t, r)), s.push(ma(e, t, r), fa(e, t, r))), s.push(vl(n, t)), s;
	}
	var jl = v(["ClassDeclaration", "ComponentDeclaration", "FunctionDeclaration", "TSInterfaceDeclaration", "DeclareClass", "DeclareComponent", "DeclareFunction", "DeclareHook", "HookDeclaration", "TSDeclareFunction", "EnumDeclaration"]);
	function vl(e, t) {
	...
	function Ea(e, t, r) {
		let { node: n } = e,
			...
			m = "",
			D = "";
		return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? (m = "*") : o && (m = r(i)), c && !Jl(n) && (D = r(a)), [ks(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1), m, m && D ? " as " : "", D];
	}
	function Jl(e) {
	...
	function dt(e, t, r) {
		...
		} else J = [D && w(s.properties) ? Ss(c) : "", p, f([t.bracketSpacing ? x : E, ...S]), b(_ && (C !== "," || ae(t)) ? C : ""), t.bracketSpacing ? x : E, A, V(e), Y(e, r)];
		return e.match((h) => h.type === "ObjectPattern" && !w(h.decorators), Ls) ||
			(we(s) &&
				(e.match(
					...
					e.match(void 0, (h, W) => h.type === "FunctionTypeParam" && W === "typeAnnotation", Ls))) ||
			(!y &&
				e.match(
	...
	function Ls(e, t) {
		return (t === "params" || t === "parameters" || t === "this" || t === "rest") && As(e);
	}
	function ql(e) {
		let t = [e];
	...
	function Vt(e, t, r, n) {
		...
		let Fe = j || C,
			...
			ee = Xl(y, m, D, t) || S || B,
			qe = !_ && !p && !i && (Z ? m.type === "NullLiteral" || (m.type === "Literal" && m.value === null) : rr(m, t) && Rn(s.test, 3)),
		...
		let vs = Symbol("test"),
			...
			Ra = u ? [ws(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""] : [r("checkType"), " ", "extends", " ", s.extendsType.type === "TSConditionalType" || s.extendsType.type === "ConditionalTypeAnnotation" || s.extendsType.type === "TSMappedType" ? r("extendsType") : l(ws(r("extendsType")))],
			Ms = l([Ra, " ?"], { id: vs }),
			Ja = r(a),
	...
	function ka(e, t, r) {
		...
		switch (n.type) {
			...
			case "TSImportEqualsDeclaration":
				return [n.isExport ? "export " : "", "import ", Is(n, !1), r("id"), " = ", r("moduleReference"), t.semi ? ";" : ""];
	...
	var Ql = v(["ClassMethod", "ClassPrivateMethod", "ClassProperty", "ClassAccessorProperty", "AccessorProperty", "TSAbstractAccessorProperty", "PropertyDefinition", "TSAbstractPropertyDefinition", "ClassPrivateProperty", "MethodDefinition", "TSAbstractMethodDefinition", "TSDeclareMethod"]);
	function Zl(e, t, r, n) {
		var D;
	...
	var sm = new Set(["start", "end", "extra", "loc", "comments", "leadingComments", "trailingComments", "innerComments", "errors", "range", "tokens"]);
	function ja(e, t) {
		let { type: r } = e;
		if (r === "ObjectProperty") {
			let { key: n } = e;
