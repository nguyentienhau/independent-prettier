(function (f) {
	...
	var $ = (t, e, r) => (Mr(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
		Yt = (t, e, r) => (e.has(t) ? Fr("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r)),
		Kt = (t, e, r, n) => (Mr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r);
	var ba = {};
	...
	var Xe = ls;
	var cs = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
	function us(t) {
...
`,
	...
	function nr(t) {
		return t.selfClosing === !0 || Ns(t.tag) || (Ts(t) && t.children.every((e) => bt(e)));
	}
	function bt(t) {
	...
	function vs(t, e, r) {
		...
		switch (n.type) {
			...
			case "BlockStatement":
				return Os(t) ? [Bs(t, r), cn(t, r, e), un(t, r, e)] : [_s(t, r), q([cn(t, r, e), un(t, r, e), Is(t, r, e)])];
			...
			case "TextNode": {
				...
				let ve = "",
					Ae = "";
				return X === 0 && ((d = t.next) == null ? void 0 : d.type) === "MustacheStatement" && (Ae = " "), H === 0 && ((N = t.previous) == null ? void 0 : N.type) === "MustacheStatement" && (ve = " "), C && ((H = 0), (ve = "")), v && ((X = 0), (Ae = "")), K.hasLeadingWhitespace(g) && (g = ve + K.trimStart(g)), K.hasTrailingWhitespace(g) && (g = K.trimEnd(g) + Ae), [...rt(H), Xt(hn(g)), ...rt(X)];
			}
	...
	function _s(t, e) {
		let { node: r } = t,
			n = [],
			s = St(t, e);
		return s && n.push(q(s)), Je(r.program.blockParams) && n.push(ir(r.program)), q([Cs(r), sr(t, e), n.length > 0 ? R([D, Ee(D, n)]) : "", Y, Ls(r)]);
	}
	function Ds(t, e) {
	...
	function Bs(t, e) {
		...
		return q([dn(n), ["else", " ", n.inverse.body[0].path.head.name], R([D, q(St(t, e)), ...(Je(r.program.blockParams) ? [D, ir(r.program)] : [])]), Y, mn(n)]);
	}
	function Is(t, e, r) {
		let { node: n } = t;
...
`).length - 1
	...
	var zs = new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
		...
		Ys = (t, e) => (e === 0 && t.startsWith("@") ? !1 : (e !== 0 && Gs.has(t)) || /\s/u.test(t) || /^\d/u.test(t) || Array.prototype.some.call(t, (r) => zs.has(r)));
	function Ks(t) {
		return t.tail.length === 0 && t.original.includes("/") ? t.original : [t.head.original, ...t.tail].map((r, n) => (Ys(r, n) ? `[${r}]` : r)).join(".");
	}
	var Ws = {
			print: vs,
			massageAstNode: Xr,
	...
	if (!1) {
		let t = (n) => {
			...
			r = (n) => String(n);
		js = (n) => (typeof n == "function" ? t(n) || "(unknown function)" : typeof n == "object" && n !== null ? e(n) || "(unknown object)" : r(n));
	}
	var ar = (function (t) {
			...
			return (
				(t.prototype.parse = function (e) {
					if (e) {
						...
						if (((r = e.match(di)), r)) return String.fromCharCode(parseInt(r[1], 10));
...
`
		...
		Yo = (function () {
			function t(e, r) {
				r === void 0 && (r = {}), (this.options = r), (this.token = null), (this.startLine = 1), (this.startColumn = 0), (this.tokens = []), (this.tokenizer = new gr(this, e, r.mode)), (this._currentAttribute = void 0);
			}
			return (
				(t.prototype.tokenize = function (e) {
	...
	var Tr = new Set(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]);
	function ki(t) {
		var e;
		return Tr.has(t.toLowerCase()) && ((e = t[0]) == null ? void 0 : e.toLowerCase()) === t[0];
	}
...
`
	...
	function Bn(t, e, r) {
		return new Br("Cannot remove a node unless it is part of an array", t, e, r);
	}
	function Pi(t, e, r) {
		return new Br("Cannot replace a node with multiple nodes unless it is part of an array", t, e, r);
	}
	function In(t, e) {
		return new Br("Replacing and removing in key handlers is not yet supported.", t, null, e);
	}
	var Fe = class {
			node;
			parent;
	...
	function Hi(t, e, r, n, s = null, i, a, o, c) {
		...
		return (
			...
			(s == null ? void 0 : s.type) === "Template"
				? (F("b.program is deprecated. Use b.blockItself instead."),
					w(s.blockParams.length === 0, "{{else}} block cannot have block params"),
					(h = f.blockItself({
						params: [],
						body: s.body,
						loc: s.loc,
	...
	function zi(t, e = {}) {
		...
		let N = n == null ? void 0 : n.map((T) => (typeof T == "string" ? zn(T) : T)),
			g = null;
		return (
			c ? (g = A(c || null)) : c === void 0 && (g = d || ki(h.original) ? null : A(null)),
			f.element({
				path: h,
				selfClosing: d || !1,
				attributes: r || [],
	...
	function A(...t) {
		if (t.length === 1) {
			let e = t[0];
			return e && typeof e == "object" ? O.forHbsLoc(Er(), e) : O.forHbsLoc(Er(), Ti);
		} else {
			let [e, r, n, s, i] = t,
				a = i ? new Te("", i) : Er();
...
`);
		...
		_r = class extends Lr {
			...
			MustacheStatement(e) {
				...
				switch (r.state) {
					...
					case "afterAttributeName":
						this.beginAttributeValue(!1), this.finishAttributeValue(), kr(this.currentStartTag, n), r.transitionTo(qn);
						break;
					case "afterAttributeValueQuoted":
						kr(this.currentStartTag, n), r.transitionTo(qn);
						break;
					case "beforeAttributeValue":
						this.beginAttributeValue(!1), this.appendDynamicAttributeValuePart(n), r.transitionTo(ia);
						break;
			...
			ContentStatement(e) {
				oa(this.tokenizer, e), this.tokenizer.tokenizePart(e.value), this.tokenizer.flushData();
			}
			CommentStatement(e) {
				let { tokenizer: r } = this;
...
`
			...
			validateEndTag(e, r, n) {
				if (Tr.has(e.name) && !n) throw S(`<${e.name}> elements do not need end tags. You should remove it`, e.loc);
	...
	function Wn(t, e = {}) {
		...
		let r = e.mode || "precompile",
			n,
			s;
		typeof t == "string" ? ((n = new Te(t, (c = e.meta) == null ? void 0 : c.moduleName)), r === "codemod" ? (s = Ct(t, e.parseOptions)) : (s = dr(t, e.parseOptions))) : t instanceof Te ? ((n = t), r === "codemod" ? (s = Ct(t.source, e.parseOptions)) : (s = dr(t.source, e.parseOptions))) : ((n = new Te("", (p = e.meta) == null ? void 0 : p.moduleName)), (s = t));
		let i;
		r === "codemod" && (i = new Or());
