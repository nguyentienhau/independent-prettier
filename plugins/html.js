(function (f) {
	...
	var Q = (t, e, r) => (Zr(t, e, "read from private field"), r ? r.call(t) : e.get(t)),
		en = (t, e, r) => (e.has(t) ? Xr("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r)),
...
`,
	...
	var $e = _i;
	var Ei = new Set(["sourceSpan", "startSourceSpan", "endSourceSpan", "nameSpan", "valueSpan", "keySpan", "tagDefinition", "tokens", "valueTokens", "switchValueSourceSpan", "expSourceSpan", "valueSourceSpan"]),
	...
	function bn(t, e) {
		...
		return r;
		function n() {
			return $e(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.prev && (t.prev.type === "text" || t.prev.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : _e(t.parent) ? !0 : !((!t.prev && (t.parent.type === "root" || (_e(t) && t.parent) || U(t.parent) || Je(t.parent, e) || !Ii(t.parent.cssDisplay))) || (t.prev && !Oi(t.prev.cssDisplay)));
		}
	}
	function Tn(t, e) {
		return $e(t) || t.type === "angularControlFlowBlock" ? !1 : (t.type === "text" || t.type === "interpolation") && t.next && (t.next.type === "text" || t.next.type === "interpolation") ? !0 : !t.parent || t.parent.cssDisplay === "none" ? !1 : _e(t.parent) ? !0 : !((!t.next && (t.parent.type === "root" || (_e(t) && t.parent) || U(t.parent) || Je(t.parent, e) || !Ri(t.parent.cssDisplay))) || (t.next && !$i(t.next.cssDisplay)));
	}
	function xn(t) {
...
` ||
	...
	function Zi(t) {
		...
		function d() {
			let C = !1,
				...
				x,
				V;
			for (F = 0; F < n.length; F++) (g = n[F]), (y = g[g.length - 1]), (M = g.substring(0, g.length - 1)), (x = parseInt(M, 10)), (V = parseFloat(M)), Un.test(M) && y === "w" ? ((A || D) && (C = !0), x === 0 ? (C = !0) : (A = x)) : Ji.test(M) && y === "x" ? ((A || D || R) && (C = !0), V < 0 ? (C = !0) : (D = V)) : Un.test(M) && y === "h" ? ((R || D) && (C = !0), x === 0 ? (C = !0) : (R = x)) : (C = !0);
	...
	function Yn(t, e) {
		let { node: r } = t,
			n = P(t.node).trim();
		if (r.fullName === "style" && !e.parentParser && !n.includes("{{")) return async (s) => Ce(await s(n, { parser: "css", __isHTMLStyleAttribute: !0 }));
	}
	var Dr = new WeakMap();
	function na(t, e) {
		let { root: r } = t;
...
` + t
	...
	function ps(t, e, r) {
		...
		let i = hs(n);
		return n.children.length > 0 ? ((n.firstChild.hasLeadingSpaces = !0), (n.lastChild.hasTrailingSpaces = !0), s.push(k([S, He(t, e, r)])), i && s.push(S, "}")) : i && s.push("}"), _(s, { shouldBreak: !0 });
	}
	function hs(t) {
		var e, r;
	...
	function gs(t, e, r) {
		...
		let s = n.children.length === 1 && (n.firstChild.type === "interpolation" || n.firstChild.type === "angularIcuExpression") && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces,
			...
			o = (l) => (s ? on(l, { groupId: i }) : (U(n) || Je(n, e)) && n.parent.type === "root" && e.parser === "vue" && !e.vueIndentScriptAndStyle ? l : k(l)),
			u = () => (s ? ge(v, "", { groupId: i }) : n.firstChild.hasLeadingSpaces && n.firstChild.isLeadingSpaceSensitive ? E : n.firstChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive ? sn(v) : v),
			p = () => ((n.next ? K(n.next) : ye(n.parent)) ? (n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? " " : "") : s ? ge(v, "", { groupId: i }) : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive ? E : (n.lastChild.type === "comment" || (n.lastChild.type === "text" && n.isWhitespaceSensitive && n.isIndentationSensitive)) && new RegExp(`\\n[\\t ]{${e.tabWidth * (t.ancestors.length - 1)}}$`, "u").test(n.lastChild.value) ? "" : v);
...
`
	...
	var Ha = "boolean",
		...
		Vt = class extends Ht {
			...
			hasElement(e, r) {
				return r.some((n) => n.name === xr.name) || (e.indexOf("-") > -1 && (kr(e) || Br(e) || r.some((n) => n.name === Tr.name))) ? !0 : this._schema.has(e.toLowerCase());
			}
	...
	var dt = class {
		...
		Mr = class {
			constructor(e, r, n) {
				...
				(this._cursor = n.escapedString ? new qr(e, s) : new rr(e, s)), (this._preserveLineEndings = n.preserveLineEndings || !1), (this._i18nNormalizeLineEndingsInICUs = n.i18nNormalizeLineEndingsInICUs || !1), (this._tokenizeBlocks = n.tokenizeBlocks ?? !0), (this._tokenizeLet = n.tokenizeLet ?? !0);
				try {
					this._cursor.init();
				} catch (i) {
					this.handleError(i);
...
`,
			...
			_consumeBlockStart(e) {
				...
				if (this._cursor.peek() === 40)
					if ((this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(b), this._attemptCharCode(41))) this._attemptCharCodeUntilFn(b);
					else {
						r.type = 29;
						return;
					}
			...
			_getLetDeclarationName() {
				let e = this._cursor.clone(),
					r = !1;
				return this._attemptCharCodeUntilFn((n) => (ot(n) || n == 36 || n === 95 || (r && It(n)) ? ((r = !0), !1) : !0)), this._cursor.getChars(e).trim();
			}
...
`
			...
			_consumeIncompleteBlock(e) {
				...
				let n = this._peek.sourceSpan.fullStart,
					...
					i = new h(e.sourceSpan.start, n, e.sourceSpan.fullStart),
					a = new Z(e.parts[0], r, [], s, e.sourceSpan, i);
				this._pushContainer(a, !1), this._popContainer(null, Z, null), this.errors.push(L.create(e.parts[0], s, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
			}
			_consumeLet(e) {
				let r = e.parts[0],
					n,
...
...`,
	...
	function No(t) {
		if (t.type === "block") {
			if (((t.name = w(!1, t.name.toLowerCase(), /\s+/gu, " ").trim()), (t.type = "angularControlFlowBlock"), !qe(t.parameters))) {
				delete t.parameters;
				return;
			}
	...
	function Zs(t, e, r) {
		let { name: n, canSelfClose: s = !0, normalizeTagName: i = !1, normalizeAttributeName: a = !1, allowHtmComponentClosingTags: o = !1, isTagNameCaseSensitive: u = !1, shouldParseAsRawText: p } = e,
