(function (t) {
	...
	var Me = (e, t, r) => ((r = e != null ? yu(wu(e)) : {}), sr(t || !e || !e.__esModule ? He(r, "default", { value: e, enumerable: !0 }) : r, e)),
		...
		diff: function (t, r) {
			...
			function A() {
				for (var h = Math.max(m, -l); h <= Math.min(E, l); h += 2) {
					...
					if ((!yt || ($ && k.oldPos + 1 < v.oldPos) ? (C = o.addToPath(v, !0, void 0, 0)) : (C = o.addToPath(k, void 0, !0, 1)), (F = o.extractCommon(C, r, t, h)), C.oldPos + 1 >= D && F + 1 >= a)) return s(Ou(o, C.lastComponent, r, t, o.useLongestToken));
...
`,
				...
				case S: {
					...
					let $ = { ind: f, mode: p, doc: Ge(m) },
						ye = m[0];
					et({ ind: f, mode: J, doc: [E, A, ye] }, [], F, D.length > 0, r, !0) ? o.push($, k, w) : C ? o.push($, v, w) : o.push($, v, h);
					break;
				}
				case x:
				case R: {
				...
				case B:
					switch (p) {
						...
						case H:
							...
							c.literal ? (f.root ? (s.push(i, f.root.value), (u = f.root.length)) : (s.push(i), (u = 0))) : ((u -= Ot(s)), s.push(i + f.value), (u = f.length));
							break;
					}
					break;
				case N:
...
` ||
	...
	function Jr(e, t) {
		...
		for (let [p, c] of f.entries()) {
			...
			let v;
			if ((o ? (v = [c]) : ((F.enclosingNode = E), (F.precedingNode = m), (F.followingNode = A), (v = [F, w, h, C, k])), ti(w, h, f, p))) (F.placement = "ownLine"), D(...v) || (A ? ue(A, F) : m ? ie(m, F) : E ? re(E, F) : re(C, F));
	...
	function ii(e, t, r) {
		...
		return !a || (r != null && r.hasLineSuffix) ? { doc: [_e([" ", i]), de], isBlock: a, hasLineSuffix: !0 } : { doc: [" ", i], isBlock: a, hasLineSuffix: !1 };
	}
	function oi(e, t) {
		let r = e.node;
		if (!r) return {};
...
in order for it to be formatted.`,
	...
	function it({ plugins: e = [], showDeprecated: t = !1 } = {}) {
		...
		for (let i of Di(Object.assign({}, ...e.map(({ options: u }) => u), rn)))
			(!t && i.deprecated) ||
				(Array.isArray(i.choices) && (t || (i.choices = i.choices.filter((u) => !u.deprecated)), i.name === "parser" && (i.choices = [...i.choices, ...ai(i.choices, r, e)])),
...
`,
	...
	function Ht(e, t) {
		...
		for (; d < i; ) for (o = t.charCodeAt(u + d), a = d++, s = d, l = 0; l < n; l++) (D = o === dn[l] ? a : a + 1), (a = jt[l]), (s = jt[l] = a > s ? (D > s ? s + 1 : D) : D > a ? a + 1 : D);
		return s;
	}
	...
	function $t(e) {
		...
		return (
			...
			r
				? {
						text: t,
						list: { title: r.title, values: r.values.map($t) },
					}
				: { text: t }
		);
	}
	...
	function gi(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
					...
					(u.choices = e.choices.map((a) =>
						a != null && a.redirect
							? {
									...a,
									redirect: {
										to: { key: e.name, value: a.redirect },
									},
								}
							: a,
					));
		...
		if (
			(e.exception ? (u.validate = (a, D, l) => e.exception(a) || D.validate(a, l)) : (u.validate = (a, D, l) => a === void 0 || D.validate(a, l)),
			e.redirect &&
				(s.redirect = (a) =>
					a
						? {
...
` + n),
	...
	function Gn(e, t, r, n, i) {
		...
		let { node: u } = e,
			{ printer: o } = t,
			s;
		return (a = o.hasPrettierIgnore) != null && a.call(o, e) ? (s = zn(e, t)) : i.has(u) ? (s = i.get(u)) : (s = o.print(e, t, r, n)), u === t.cursorNode && (s = Qe(s, (D) => [ve, D, ve])), o.printComment && (!o.willPrintOwnComments || !o.willPrintOwnComments(e, t)) && (s = Qr(e, s, t)), s;
	}
	async function Qt(e, t) {
		let r = e.comments ?? [];
		(t[Symbol.for("comments")] = r), (t[Symbol.for("tokens")] = e.tokens ?? []), (t[Symbol.for("printedComments")] = new Set()), Jr(e, t);
		let {
	...
	async function iu(e, t, r = 0) {
		...
		if (t.cursorOffset >= 0) {
			let a, D, l, d, f;
			if ((t.cursorNode && o.cursorNodeText ? ((a = t.locStart(t.cursorNode)), (D = i.slice(a, t.locEnd(t.cursorNode))), (l = t.cursorOffset - a), (d = o.cursorNodeStart), (f = o.cursorNodeText)) : ((a = 0), (D = i), (l = t.cursorOffset), (d = 0), (f = o.formatted)), D === f))
				return {
...
`,
	...
	function ru(e, t) {
		...
		return (r = tr(e, r, -1)), (n = tr(e, n, 0)), (i = tr(e, i, e.length)), { ...t, cursorOffset: r, rangeStart: n, rangeEnd: i };
	}
	function ou(e, t) {
...
`,
	...
	async function rr(e, t) {
		...
		if ((i.rangeStart >= i.rangeEnd && n !== "") || (i.requirePragma && !(await nu(n, i)))) return { formatted: e, cursorOffset: t.cursorOffset, comments: [] };
		let u;
		return i.rangeStart > 0 || i.rangeEnd < n.length ? (u = await $i(n, i)) : (!i.requirePragma && i.insertPragma && i.printer.insertPragma && !(await nu(n, i)) && (n = i.printer.insertPragma(n)), (u = await iu(n, i))), r && ((u.formatted = uu + u.formatted), u.cursorOffset >= 0 && u.cursorOffset++), u;
	}
