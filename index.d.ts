...
export type BuiltInParserName = "acorn" | "angular" | "babel-flow" | "babel-ts" | "babel" | "css" | "espree" | "flow" | "glimmer" | "graphql" | "html" | "json-stringify" | "json" | "json5" | "jsonc" | "less" | "lwc" | "markdown" | "mdx" | "meriyah" | "scss" | "typescript" | "vue" | "yaml";
 ...
 */
export function resolveConfig(fileUrlOrPath: string | URL, options?: ResolveConfigOptions): Promise<Options | null>;
...
export type SupportOption = IntSupportOption | IntArraySupportOption | StringSupportOption | StringArraySupportOption | BooleanSupportOption | BooleanArraySupportOption | ChoiceSupportOption | PathSupportOption | PathArraySupportOption;
...
export namespace util {
	...
	function getAlignmentSize(text: string, tabWidth: number, startIndex?: number | undefined): number;

	function getIndentSize(value: string, tabWidth: number): number;

	function skipNewline(text: string, startIndex: number | false, options?: SkipOptions | undefined): number | false;
	...
	function makeString(rawText: string, enclosingQuote: Quote, unescapeUnnecessaryEscapes?: boolean | undefined): string;

	function skip(characters: string | RegExp): (text: string, startIndex: number | false, options?: SkipOptions) => number | false;

	const skipWhitespace: (text: string, startIndex: number | false, options?: SkipOptions) => number | false;

	const skipSpaces: (text: string, startIndex: number | false, options?: SkipOptions) => number | false;

	const skipToLineEnd: (text: string, startIndex: number | false, options?: SkipOptions) => number | false;

	const skipEverythingButNewLine: (text: string, startIndex: number | false, options?: SkipOptions) => number | false;
